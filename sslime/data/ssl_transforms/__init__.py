...
from sslime.data.ssl_transforms.ssl_jigsaw import SSL_JIGSAW
from sslime.data.ssl_transforms.ssl_jigsaw_colorization import SSL_JIGSAW_COLORIZATION
...
TRANSFORMS = {"ssl_rotate": SSL_IMG_ROTATE,
              "ssl_jigsaw": SSL_JIGSAW,
              "ssl_jigsaw_colorization": SSL_JIGSAW_COLORIZATION
             }
